...
@endif
 <form wire:submit.prevent="saveLocalEat">
...
<div wire:ignore>
                                        <textarea data-note="@this" wire:model.defer="description" class="form-control @error('description') is-invalid @enderror" rows="5" id="editornote1"></textarea>
                                    </div>
                                     </div>
                                     @error('description')
