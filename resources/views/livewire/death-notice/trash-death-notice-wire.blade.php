<div class="card">
    ...
    <h3 class="card-title">{{ __('List of Trash Death Notice') }}</h3>
    ...
    <td>
        <button  wire:click="restoreConfirm('restore', {{ $notice->id }})" class="btn btn-info">Restore</button>
        <button wire:click="deleteConfirm('delete', {{ $notice->id }})" class="btn btn-danger">Delete</button>
