...
<h3 class="card-title">Edit Transport -  {{ $name }}</h3>
</div>
 
<div class="card-body">

 <form wire:submit.prevent="editTransport">
    @csrf
<div class="card-body">
...
<div wire:ignore>
                                        <textarea data-note="@this" wire:model.defer="description" class="form-control @error('description') is-invalid @enderror" rows="5" id="editornote1">{{ $description }}</textarea>
                                    </div>
                                     </div>
                                     @error('description')
