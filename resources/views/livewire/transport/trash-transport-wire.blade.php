<div class="card">
    ...
    <h3 class="card-title">{{ __('List of Trash Transport') }}</h3>
    ...
    <td>
        <button  wire:click="restoreConfirm('restore', {{ $transport->id }})" class="btn btn-info">Restore</button>
        <button wire:click="deleteConfirm('delete', {{ $transport->id }})" class="btn btn-danger">Delete</button>
    </td>
    </tr>
    @empty
    <tr>
