<div class="card">
    ...
    <h3 class="card-title">{{ __('Planning Application') }}</h3>
...
@endif
    ...
    <td>
        <a href="{{ route('admin.planning-applications.edit',$planningApplication->id) }}" class="btn btn-info">Edit</a>
        <button wire:click="trashConfirm('trash', {{ $planningApplication->id }})" class="btn btn-danger">Trash</button>
    </td>
    </tr>
    @empty
    <tr>
    <td>No Planning Applications Found.</td>
    </tr>
    @endforelse
    </tbody>
    </table>
