...
<select wire:model="parent_location" class="form-control  @error('parent_location') is-invalid @enderror" >
<option value="">None</option>
@foreach($directoryListingLocations as $location)
...
<div class="form-group">
  ...
  <div wire:ignore>
                                          <textarea data-note="@this" wire:model.defer="description" class="form-control" rows="5" id="editornote1"></textarea>
                                      </div>
                                       </div>
                                       @error('description')
                                      <span style="padding-left: 0;color: red;font-size: 14px;"
