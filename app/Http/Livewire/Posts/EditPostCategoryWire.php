...
class EditPostCategoryWire extends Component
{
    use WithFileUploads;
    ...
    public function updateCategory()
    {
        ...
        if ($this->image) {
            ...
            $imagePath = $this->image->storeAs('images/categories/posts', $this->category->slug.'.'.$extension, 'public');
    ...
    {
        return view('livewire.posts.edit-post-category-wire');
    }
}
